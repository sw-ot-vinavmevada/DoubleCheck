...
import TestCases.CreateHardwareKit.HWKitWaterQualityTC;
import com.relevantcodes.extentreports.LogStatus;
import org.openqa.selenium.WebDriver;
import org.testng.Assert;
import org.testng.annotations.Test;

public class CreateWaterQualityUserTC extends BaseTest {

    int Flag = 1;

    public CreateWaterQualityUserTC(WebDriver driver, int flag) {
        this.driver = driver;
        this.Flag = flag;
    }
...
*/
    ...
    @Test
    public void VerifyCreateCompanyUser() throws Exception {
        if (Flag > 0) {
            ExtentTestManager.getTest().getTest().setName("Add Company User For Water Quality Test Started");
            ExtentTestManager.getTest().assignCategory("Elevator Solution");
            log.info("Create Company User For Water Quality Solution Test Started");
        }


        //Pre Condition:- Create Hardware Kit
        HWKitWaterQualityTC hwKitWaterQualityTC = new HWKitWaterQualityTC(driver,1);
        //hwKitWaterQualityTC.verifyAddHWKit();
        ...
        ExtentTestManager.getTest().log(LogStatus.PASS, "Enter Address", "Test Data: TestAddress");
        ...
        Assert.assertTrue(commonMethods.enterTextInInputField(companyUserPO.email_Txt, companyUserLoginPO.email_Str_Wat), "Unable to Enter Email Address");
        ExtentTestManager.getTest().log(LogStatus.PASS, "Enter Email Address", "Test Data: "+companyUserLoginPO.email_Str_Wat);
...
/*
        ...
        ExtentTestManager.getTest().log(LogStatus.PASS, "Enter Card Name", "Test Data: "+companyUserPO.cardNumberStr);
