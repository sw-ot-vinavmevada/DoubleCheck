...
public class CreateAssetUserTC extends BaseTest {

    int Flag = 1;

    public CreateAssetUserTC(WebDriver driver, int flag) {
        this.driver = driver;
        this.Flag = flag;
    }
...
*/
    ...
    @Test
    public void verifyCreateCompanyUser_Assets() throws Exception {
        if (Flag > 0) {
            ExtentTestManager.getTest().getTest().setName("Add Company User For Lighting Test Started");
