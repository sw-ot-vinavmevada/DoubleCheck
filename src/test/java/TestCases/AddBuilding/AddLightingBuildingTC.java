...
import TestCases.Login.CompanyUserLogin.*;
...
public class AddLightingBuildingTC extends BaseTest {

    int Flag = 1;



    public AddLightingBuildingTC(WebDriver driver, int flag) {
        this.driver = driver;
        this.Flag = flag;
    }
    ...
    @Test
    public void VerifyCreateBuilding_Lighting() throws Exception {
        if (Flag > 0) {
        ...
        LightingUserLoginTC lightingUserLoginTC = new LightingUserLoginTC(driver,1);
        lightingUserLoginTC.verifyLogin_Light();
