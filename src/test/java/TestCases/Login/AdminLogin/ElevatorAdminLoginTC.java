...
public class ElevatorAdminLoginTC extends BaseTest {

    int Flag = 1;
    public ElevatorAdminLoginTC(WebDriver driver, int flag){
        this.driver =driver;
        this.Flag = flag;
    }
    ...
    public void verifyLogin() throws Exception {
        ...
        if (Flag > 0) {
            ExtentTestManager.getTest().getTest().setName("Smart Elevator solution Test Started");
        ...
        //Step 1: Open URL
        Assert.assertTrue(commonMethods.openUrl(adminLoginPO.SmartElevatorAdmin), "Unable to Open End User URL");
