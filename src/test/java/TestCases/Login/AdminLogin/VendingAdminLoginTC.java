...
public class VendingAdminLoginTC extends BaseTest {

    int Flag = 1;
    public VendingAdminLoginTC(WebDriver driver, int flag){
        this.driver =driver;
        this.Flag = flag;
    }
    ...
    public void verifyLogin() throws Exception {
        ...
        if (Flag > 0) {
            ExtentTestManager.getTest().getTest().setName("Smart Vending Machine solution Test Started");
        ...
        //Step 1: Open URL
        Assert.assertTrue(commonMethods.openUrl(adminLoginPO.VendingMachineAdminUrl), "Unable to Open End User URL");
